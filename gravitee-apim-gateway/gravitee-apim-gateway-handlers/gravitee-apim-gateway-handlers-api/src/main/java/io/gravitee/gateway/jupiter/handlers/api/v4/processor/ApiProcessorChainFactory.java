...
public class ApiProcessorChainFactory {
    ...
    public ProcessorChain preProcessorChain(final Api api) {
        ...
        Optional<ListenerHttp> listenerHttpOpt = getListenerHttp(api);
        if (listenerHttpOpt.isPresent()) {
            ListenerHttp listenerHttp = listenerHttpOpt.get();
            Cors cors = listenerHttp.getCors();
            ...
            Logging logging = listenerHttp.getLogging();
    ...
    public ProcessorChain postProcessorChain(final Api api) {
        ...
        if (listenerHttpOpt.isPresent()) {
            ...
            Map<String, Pattern> pathMappings = listenerHttp.getPathMappingsPattern();
    ...
    private Optional<ListenerHttp> getListenerHttp(final Api api) {
        return api
            .getDefinition()
            .getListeners()
            .stream()
