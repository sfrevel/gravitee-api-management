 ...
 */
public class DebugResponseStep extends DebugStep<MutableResponse> {

    public DebugResponseStep(String policyId, ExecutionPhase executionPhase, final String flowPhase) {
        super(policyId, executionPhase, flowPhase);
    }

    @Override
    public Single<DebugStepState> saveInputState(final MutableResponse response, final Map<String, Serializable> inputAttributes) {
        return response
            .bodyOrEmpty()
            .map(inputBody ->
                new DebugStepState()
