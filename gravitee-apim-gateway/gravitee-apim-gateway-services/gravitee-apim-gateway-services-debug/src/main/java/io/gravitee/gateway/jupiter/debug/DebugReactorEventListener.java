...
public class DebugReactorEventListener
            ...
            if (debugApi != null) {
                ...
                try {
                    ...
                    vertx
                        ...
                        .doOnSuccess(httpClientResponse -> logger.info("Response status: {}", httpClientResponse.statusCode()))
    ...
    private MultiMap convertHeaders(Map<String, List<String>> headers) {
